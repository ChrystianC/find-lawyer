...
{
    return ( <footer className='container px-5 py-16 mx-auto max-h-24 flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col'>
        <div className='w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left md:mt-0 mt-10 pb-5'>
            <a className='flex title-font font-medium items-center md:justify-start justify-center text-gray-900 '>
                <Image src={ libra } alt='libra' width={ 64 } height={ 64 } priority={ false } className='rounded-full bg-gray-900 border-4 border-gray-700' />
                <span className='ml-3 text-xl'>Lawyer</span></a>
