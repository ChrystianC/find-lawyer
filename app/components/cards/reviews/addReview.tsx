...
export default function AddReview({ create, office, isDisabled }) {
    ...
    return (
        < >
            ...
            <input type='checkbox' id={`star-${office}-2`} value='2' className='hidden peer' disabled={isDisabled}  onChange={async (e) => { setRating(e.target.value); await create(2, office) }}></input>
            ...
            <input type='checkbox' id={`star-${office}-3`} value='3' className='hidden peer' disabled={isDisabled}  onChange={async (e) => { setRating(e.target.value); await create(3, office) }}></input>
            ...
            <input type='checkbox' id={`star-${office}-4`} value='4' className='hidden peer' disabled={isDisabled}  onChange={async (e) => { setRating(e.target.value); await create(4, office) }}></input>
            ...
            <input type='checkbox' id={`star-${office}-5`} value='5' className='hidden peer' disabled={isDisabled}  onChange={async (e) => { setRating(e.target.value); await create(5, office) }}></input>
