...
export default async function LawOfficeCardsPage ()
{
    ...
    const renderLawOffice = getLawOffice.map( async ( { idLawOffice, profile, lawOfficeName, city, address, officeSpecialization } ) =>
    {
        ...
        return ( <div className='container  px-5 py-5 mx-auto min-h-lvh' >
                ...
                <div className='lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0'>
                    <div className='flex flex-row items-center'>
                        ...
                        <div className='flex flex-col ml-2'>
                            ...
                            <h1 className='text-gray-900 text-3xl title-font font-medium mb-1 hover:text-indigo-500'><Link href={ `/components/cardPreview?${ idLawOffice }` }>{ lawOfficeName }</Link></h1>
                        </div>
                    </div>
