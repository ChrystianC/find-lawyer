...
export default function EditForm ( { edit, lawOffice, deleteLawOffice, newAppoiment, mapLocation, mapSpecialization } )
{
    ...
    return <>
        <div className="flex flex-wrap -m-4">
            ...
            <div className="xl:w-1/3 md:w-1/2 p-4">
                <div className="border border-gray-200 p-6 rounded relative">
                    ...
                    <p className="leading-relaxed text-base"></p>
                    <AddApoiment lawOffice={ lawOffice } newAppoiment={ newAppoiment } />
                </div>
            </div>
        </div>
        <div className="text-4xl flex mx-auto mt-16 text-white  border-0 py-2 px-8 focus:outline-none rounded justify-around"><DeleteButton lawOffice={ lawOffice } deleteLaw={ deleteLawOffice } />
        ...
        <div className="flex mx-auto justify-center mt-1">
            <div className="w-4/5 h-1 rounded-full bg-indigo-500 inline-flex"></div>
        </div>
    </>;
}