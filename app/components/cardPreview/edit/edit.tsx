...
export default function EditForm({
  ...
  const [lawOfficeName, setLawOfficeName] = useState(
    lawOffice.lawOfficeName ?? undefined
  );
  const [officeSpecialization, setOfficeSpecialization] = useState(
    lawOffice.officeSpecialization ?? undefined
  );
  ...
  return (
    <>
      <div className="flex flex-wrap -m-4">
        <div className="xl:w-1/3 md:w-1/2 p-4">
          <div className="border border-gray-200 p-6 rounded ">
            ...
            <label
              htmlFor={`hero-field-${lawOffice.idLawOffice}-officeSpecialization`}
        ...
        <div className="xl:w-1/3 md:w-1/2 p-4">
          <div className="border border-gray-200 p-6 rounded ">
            ...
            <p className="leading-relaxed text-base"></p>
            <label
              htmlFor={`hero-field-${lawOffice.idLawOffice}-lawOfficeName`}
              className="leading-7 text-sm text-gray-600"
            >
              Office Name
            </label>
            <input
              type="text"
              disabled={isNotOffice}
              id={`hero-field-${lawOffice.idLawOffice}-lawOfficeName`}
              name="hero-field"
              className="w-full bg-gray-100 rounded border bg-opacity-50 border-gray-300 focus:ring-2 focus:ring-indigo-200 focus:bg-transparent focus:border-indigo-500 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
              value={lawOfficeName}
        ...
        <div className="xl:w-1/3 md:w-1/2 p-4">
          <div className="border border-gray-200 p-6 rounded ">
            ...
            <p className="leading-relaxed text-base"></p>
            <label
              htmlFor={`hero-field-${lawOffice.idLawOffice}-address`}
              className="leading-7 text-sm text-gray-600"
            >
              Office Address
            </label>
            <input
              type="text"
              disabled={isNotOffice}
              id={`hero-field-${lawOffice.idLawOffice}-address`}
              name="hero-field"
              className="w-full bg-gray-100 rounded border bg-opacity-50 border-gray-300 focus:ring-2 focus:ring-indigo-200 focus:bg-transparent focus:border-indigo-500 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
              value={address}
        ...
        <div className="xl:w-1/3 md:w-1/2 p-4">
          <div className="border border-gray-200 p-6 rounded ">
            ...
            <p className="leading-relaxed text-base"></p>
            <label
              htmlFor={`hero-field-${lawOffice.idLawOffice}-city`}
              className="leading-7 text-sm text-gray-600"
            >
              Office City
            </label>
        ...
        <div className="xl:w-1/3 md:w-1/2 p-4">
          <div className="border border-gray-200 p-6 rounded">
            ...
            <p className="leading-relaxed text-base"></p>
            <label
              htmlFor={`hero-field-${lawOffice.idLawOffice}-profile`}
              className="leading-7 text-sm text-gray-600"
            >
              Office Profile
            </label>
            <input
              type="text"
              disabled={isNotOffice}
              id={`hero-field-${lawOffice.idLawOffice}-profile`}
              name="hero-field"
              className="w-full bg-gray-100 rounded border bg-opacity-50 border-gray-300 focus:ring-2 focus:ring-indigo-200 focus:bg-transparent focus:border-indigo-500 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
              value={profile}
        ...
        <div className="xl:w-1/3 md:w-1/2 p-4 mb-4">
          <div className="border border-gray-200 p-6 rounded relative">
            ...
            <AddApoiment
              lawOffice={lawOffice}
              newAppoiment={newAppoiment}
              isDisabled={isNotOffice}
            />
          </div>
        </div>
      </div>
      {!isNotOffice ? (
        <>
          <div className="text-4xl flex mx-auto mt-16 text-white  border-0 py-2 px-8 focus:outline-none rounded justify-around">
            <DeleteButton lawOffice={lawOffice} deleteLaw={deleteLawOffice} />
            <button
              className="focus:outline-none font-medium leading-5 text-gray-800 dark:text-gray-100 mt-2 border-5 border-transparent inline-block hover:border-gray-700  hover:text-gray-900 p-4 border rounded disabled:opacity-15 disabled:border-none"
              onClick={() =>
                edit(
                  city,
                  address,
