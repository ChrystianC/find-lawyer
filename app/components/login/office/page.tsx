      ...
      <div className="container px-5 py-24 mx-auto border border-gray-200 m-5">
        <div className="text-center mb-12">
          <h1 className="sm:text-3xl text-2xl font-medium title-font text-gray-900 mb-4">
            Great to see you! Log in to quickly and conveniently organise your
            law office appoiments.
          </h1>
          <p className="text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto text-gray-500s">
            Log in to improving the process of booking legal services and
            increasing the number of clients through access to other clients'
            reviews.
          </p>
          <div className="flex mt-6 justify-center">
            <div className="w-24 h-1 rounded-full bg-gray-900 inline-flex"></div>
          </div>
        </div>
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="flex mx-auto mt-10 text-white bg-gray-700 border-0 py-2 px-8 focus:outline-none hover:bg-gray-900 rounded text-lg"
          >
            Sign in
          </button>
        </form>
      ...
      <div className="container mx-auto flex flex-col p-5 lg:flex-row items-center">
        ...
        <div>
          <Link
            ...
            href={"/components/login/office/register"}
          >
            Register office
          </Link>
        </div>
