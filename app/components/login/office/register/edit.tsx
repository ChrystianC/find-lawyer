    ...
    const handleSubmit = async ( e ) =>
    {
        ...
        try
        {
            const response = await fetch( 'http://localhost:3555/register/office', {
                ...
                body: JSON.stringify( { city, lawOfficeName, email, password, address, officeSpecialization } ),
            } );
    ...
    return ( <>
        ...
        <form onSubmit={ handleSubmit }>
            ...
            <div className="container px-5 py-24 mx-auto ">
                ...
                <div className="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
                    <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0">
                        <h2 className="text-gray-900 text-lg title-font font-medium mb-2">The law office name</h2>
                        <div className="relative flex-grow w-full">
                            <input type="text" name="lawOfficeName"
                                value={ lawOfficeName }
                ...
                <div className="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
                    <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0">
                        <h2 className="text-gray-900 text-lg title-font font-medium mb-2">Which city are you placed in?</h2>
                        <div className="relative flex-grow w-full">
                ...
                <div className="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
                    ...
                    <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0">
                        <h2 className="text-gray-900 text-lg title-font font-medium mb-2">Customer's need an address of yours</h2>
                        <div className="relative flex-grow w-full">
