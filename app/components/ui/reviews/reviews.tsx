...
export default async function Reviews({ ratings }) {
    ...
    return (
        <div className='text-center flex justify-center items-center group relative' key={ratings[0].idOffice}>
            ...
            <span className='absolute top-5 scale-0 rounded bg-gray-800 p-2 group-hover:scale-100'><AddReview create={create} office={ratings[0].idOffice} /></span>
        </div>
    )
